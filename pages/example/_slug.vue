            ...
            <!-- <div class="w-full mt-6">
                <table class="overflow-hidden mx-auto">
                    <tr v-for="example, index in example.body" :key="index">
                        ...
                        <td class="p-6 text-gray-900 font-mono [width:480px] align-top" :class="{ 'bg-gray-100': example.code !== '' }"><pre v-html="example.code"></pre></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="w-full mt-6">
                <table class="overflow-hidden mx-auto">
                    <tr v-for="execute, index in execute.body" :key="index">
                        ...
                        <td class="p-6 text-gray-900 font-mono [width:480px] align-top" :class="{ 'bg-gray-100': execute.code !== '' }"><pre v-html="execute.code"></pre></td>
                    </tr>
                </table>
            </div> -->
