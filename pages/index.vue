    ...
    <div class="space-y-10">
        ...
        <div>
            ...
            <ul class="grid sm:grid-cols-2 gap-6 xl:gap-8">
                ...
                <li>
                    <a href="/discord" class="flex items-start space-x-4 rounded-md hover:bg-gray-50 p-3 hover:shadow-sm">
                ...
                <li>
                    <a href="http://twitter.com/ghost___lang" class="flex items-start space-x-4 rounded-md hover:bg-gray-50 p-3 hover:shadow-sm">
