<footer class="bg-white mt-48">
    <div class="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        ...
        <div class="mt-8 flex justify-center space-x-6">
            <a href="https://twitter.com/ghost___lang" class="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://github.com/ghost-language" class="text-gray-400 hover:text-gray-500">
        ...
        <p class="mt-8 mx-auto max-w-xl text-center text-sm text-gray-400">
